...
void ProcessKeyboard(void)
{
   ...
   //=======================================================================================
    if (keys['L'])
    {
             jellyFishBody_LIGHT_POSITION_01[0]         +=  .1;
    }
    if (keys['J'])
    {
             jellyFishBody_LIGHT_POSITION_01[0]         -=  .1;
    ...
    if (keys['I'])
    {
             jellyFishBody_LIGHT_POSITION_01[1]         += .1;
    } 
    if (keys['K'])
    {
             jellyFishBody_LIGHT_POSITION_01[1]         -=  .1;
    ...
    if (keys['O'])
    {
             jellyFishBody_LIGHT_POSITION_01[2]         +=  .1;
    }
    if (keys['U'])  
    {
             jellyFishBody_LIGHT_POSITION_01[2]         -=  .1;
...
/*             
         //------------------------------------------------------------------------------------------------------------------------------
         outSettings << "var         jellyFishBody_LIGHT_POSITION_01[]      =  {"   
                                 << jellyFishBody_LIGHT_POSITION_01[0]     << ", "
                                 << jellyFishBody_LIGHT_POSITION_01[1]     << ", "
                                 << jellyFishBody_LIGHT_POSITION_01[2]     << ", "           
                                  
                                 << jellyFishBody_LIGHT_POSITION_01[3]     << "};\n\n";            
         ...
         //-------------------------------------------------------------------------------------------------------------------------------
         outSettings << "var         jellyFishBody_SHININESS        =  "    
                                  << jellyFishBody_SHININESS       << ";\n";   
         //------------------------------------------------------------------------------------------------------------------------------
